...
const GAME_LIVES = 3; // Initial number of lives
const LASER_DIST = 0.6; // Maximum distance laser can travel as a fraction of screen width
...
const ROID_SIZE = 100; // Initial size of asteroids in pixels
const ROID_SPD = 50; // Maximum starting speed of asteroids in pixels per second
const ROID_VERT = 10; // Average number of vertices on each asteroid
const SAVE_KEY_SCORE = "highscore"; // Save key for local storage of high score
const SHIP_BLINK_DUR = 0.1; // Duration in seconds of a single blink during the ship's invisibility
...
// Get the game canvas element by its id
